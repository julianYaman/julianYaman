# 💫About Me :
I'm Julian Yaman, a 20 year old computer science student from Germany 
who loves to code Discord bots and web apps. 
Currently, I'm trying to improve my JavaScript and TypeScript skills and learn more about serverless
...
My most popular project is my Wikipedia Discord Bot (used by 1,2m users; almost 6,5k users). 

Another main project is my Discord Bot Dashboard for developers. 
It helps developers to manage their bot and its behavior on a graphical user interface. 
